        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(
                onPressed: () {}, 
                icon: Icon(CupertinoIcons.heart, color: Color(0xFF13B8A8)),
              ),
              IconButton(
                onPressed: () {
                  context.read<SignInBloc>().add(SignOutRequired());
                },
                icon: Icon(CupertinoIcons.arrow_right_to_line, color: Color(0xFF13B8A8)),
              ),
              ...
              if (homeState.view == HomeScreenView.events) {
                return BlocBuilder<GetEventBloc, GetEventState>(
                  builder: (context, eventState) {
                    ...
                    return Center(child: CircularProgressIndicator(color: Color(0xFF13B8A8)));
                  },
                );
