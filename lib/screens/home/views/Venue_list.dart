        ...
        return Padding(
          ...
          child: Material(
            ...
            child: InkWell(
              ...
              child: _buildVenueRow(venue, context),
            ),
          ),
        );
      },
...
Widget _buildVenueRow(venue, BuildContext context) {
    return BlocBuilder<UserBloc, UserState>(
      builder: (context, state) {
        if (state is UserLoaded) {
          String userId = state.user.userId;
          ...
          // Return a placeholder or loading indicator when user data is not loaded
          return const Center(
          child: Padding(
